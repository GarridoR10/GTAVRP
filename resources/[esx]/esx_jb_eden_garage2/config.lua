...
Config.Garages = {
	...
	Garage_Apartments = {	
		Pos = {x = 326.7,y = -198.45,z = 54.09 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Apartments Garage',
		HelpPrompt = "Press ~INPUT_PICKUP~ to open up garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x = 331.91,y = -206.32,z = 54.09 },
			Heading = 156.38,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ to open up vehicle menu",
			Functionmenu = ListVehiclesMenu,
...
Config.GaragesMecano = {
	Bennys = {
		...
		SpawnPoint = {
			...
			Heading = 303.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ to list vehicles",
			Functionmenu = ListVehiclesFourriereMenu,
		},
		DeletePoint = {
			Pos = {x = 459.733,y = -1890.335,z = 25.776},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Press ~INPUT_PICKUP~ to park vehicle",
