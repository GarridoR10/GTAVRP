...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			...
			if displayHud then
				DrawAdvancedText(0.1800 - x, 0.89 - y, 0.005, 0.0028, 0.6, mph, 185, 185, 185, 255, 6, 1)
				DrawAdvancedText(0.2000 - x, 0.90 - y, 0.005, 0.0028, 0.3, "mp/h", 185, 185, 185, 255, 6, 1)
				DrawAdvancedText(0.2200 - x, 0.89 - y, 0.005, 0.0028, 0.6, fuel, 185, 185, 185, 255, 6, 1)
				DrawAdvancedText(0.2400 - x, 0.90 - y, 0.005, 0.0028, 0.3, "Fuel", 185, 185, 185, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
		end
